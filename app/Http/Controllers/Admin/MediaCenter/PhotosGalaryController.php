        ...
        try {
            ...
            if ($request->hasFile('files')) {
                ...
                foreach ($files as $file) {
                    ...
                    $originalRel   = "images/photos-galary/{$post->id}/{$uniqueName}";
                    $thumbRel      = "images/photos-galary/{$post->id}/thumbnails/{$uniqueName}";

                    $originalDir   = public_path("images/photos-galary/{$post->id}");
                    $thumbDir      = public_path("images/photos-galary/{$post->id}/thumbnails");
