<div class="relative bg-transparent rounded-xl overflow-hidden w-full max-w-xs" data-aos="fade-up"
    ...
    <div
        class="relative z-10 flex flex-col items-center text-center p-4 transition-transform duration-500 ease-in-out hover:scale-105 w-full">
