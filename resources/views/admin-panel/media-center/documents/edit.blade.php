...
@section('title', __('adminlte::menu.documents') . ' - ' . __('adminlte::adminlte.editNews'))

@section('content_header')
    <div class="row">
        <ol class="breadcrumb float-sm-left">
            <li class="breadcrumb-item"><a
                    href="{{ localizedRoute('documents.index') }}">{{ __('adminlte::menu.documents') }}</a></li>
...
@section('content')
    ...
    @endif
    <form action="{{ localizedRoute('documents.update', ['document' => $post->id]) }}" method="POST"
