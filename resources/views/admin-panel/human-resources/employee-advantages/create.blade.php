...
@php
    $route = 'employee-advantages';
    $id = 'employee_advantage';
@endphp

@section('title', __('adminlte::menu.employeeAdvantages') .' - '. __('adminlte::adminlte.createNewPost'))

@section('content_header')
    <div class="row">
        <ol class="breadcrumb float-sm-left">
            <li class="breadcrumb-item"><a
                    href="{{ localizedRoute("$route.index") }}">{{ __('adminlte::menu.employeeAdvantages') }}</a></li>
